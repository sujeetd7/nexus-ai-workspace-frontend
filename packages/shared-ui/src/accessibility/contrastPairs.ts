...
export const REQUIRED_CONTRAST_PAIRS: readonly ContrastPair[] = [
  ...
  {
    id: "light.text/surfaceMuted",
    theme: "light",
    foregroundToken: "semantic.text",
    backgroundToken: "semantic.surfaceMuted",
    foreground: lightSemanticColors.text,
    background: lightSemanticColors.surfaceMuted,
    level: "aa-normal",
  },
  {
    id: "light.textSecondary/surfaceMuted",
    theme: "light",
    foregroundToken: "semantic.textSecondary",
    backgroundToken: "semantic.surfaceMuted",
    foreground: lightSemanticColors.textSecondary,
  ...
  {
    id: "dark.text/surfaceMuted",
    theme: "dark",
    foregroundToken: "semantic.text",
    backgroundToken: "semantic.surfaceMuted",
    foreground: darkSemanticColors.text,
    background: darkSemanticColors.surfaceMuted,
    level: "aa-normal",
  },
  {
    id: "dark.textSecondary/surfaceMuted",
    theme: "dark",
    foregroundToken: "semantic.textSecondary",
    backgroundToken: "semantic.surfaceMuted",
    foreground: darkSemanticColors.textSecondary,
