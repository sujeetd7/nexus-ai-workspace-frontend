...
export const tokens = createTokens({
  ...
  size: {
    ...
    sectionLabel: typography.size.sectionLabel,
...
export const fonts = {
  body: createFont({
    ...
    lineHeight: {
      ...
      sectionLabel: typography.lineHeight.sectionLabel,
    ...
    letterSpacing: {
      ...
      sectionLabel: typography.letterSpacing.sectionLabel,
...
export const themes = {
  light: {
    ...
    borderSubtle: lightSemanticColors.borderSubtle,
    surface: lightSemanticColors.surface,
    surfaceMuted: lightSemanticColors.surfaceMuted,
  ...
  dark: {
    ...
    borderSubtle: darkSemanticColors.borderSubtle,
    surface: darkSemanticColors.surface,
    surfaceMuted: darkSemanticColors.surfaceMuted,
